...
public class MainActivity extends AppCompatActivity {
    ...
    private void requestDownload(String familyName) {
        ...
        FontRequest request;
        // Just for the sake of showing that Lobster Two, is now our "downloaded font"
        if (familyName.contentEquals("Lobster Two")) {
            request = new FontRequest(
                    "com.saantiaguilera.testing.authority",
                    "com.example.android.downloadablefonts",
                    query,
                    R.array.my_own_certs);
        } else {
            request = new FontRequest(
